...
- This feature both benchmarks anomaly models and performs the one-time `anomaly_count` enrichment described in Phase 5's deferred-field design; ongoing/continuous anomaly scoring as new batches arrive (Phase 15) re-triggers this same scoring-and-enrichment logic rather than requiring separate new logic.
